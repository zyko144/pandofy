    ...
    <footer className="player">
      ...
      <div className="player-extra-controls">
        ...
        <button onClick={handleRefresh} title="Actualiser"
          style={{ background: 'none', border: 'none', cursor: 'pointer', color: checkingUpdate ? '#FF6600' : 'var(--color-text-muted)', padding: '4px', display: 'flex', alignItems: 'center' }}>
          <RefreshCw size={15} style={{ animation: checkingUpdate ? 'spin 0.6s linear infinite' : 'none' }} />
        </button>
