...
if (userCount.c === 0) {
  ...
  const defaultTracks = [
    { id: 101, title: 'Neon Horizon', artistName: 'Pandofy Beats', artistId: 'zyko921', genre: 'Electro House', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', coverUrl: 'https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?w=500&auto=format&fit=crop&q=60', likes: 42, plays: 1204, uploadDate: Date.now() - 1000*60*60*24*3, isDefault: 1 },
    { id: 102, title: 'Solitude Groove', artistName: 'Lofi Cafe', artistId: 'zyko921', genre: 'Lo-Fi', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', coverUrl: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500&auto=format&fit=crop&q=60', likes: 85, plays: 3519, uploadDate: Date.now() - 1000*60*60*24*2, isDefault: 1 },
    { id: 103, title: 'Amber Skyline', artistName: 'Sunset Rider', artistId: 'zyko921', genre: 'Synthwave', audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', coverUrl: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=500&auto=format&fit=crop&q=60', likes: 121, plays: 8902, uploadDate: Date.now() - 1000*60*60*24*1, isDefault: 1 }
  ];
  for (const t of defaultTracks) insertTrack.run(t);
}
